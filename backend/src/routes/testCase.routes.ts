...
// router.post("/get-test-case/:id", authMiddleware, validateRequest(IdSchema), TestCaseController.getTestCaseById);
...
router.delete("/delete-test-case/:id", authMiddleware, validateRequest(IdSchema), TestCaseController.deleteTestCase);
