...
const CreateNewTest: React.FC = () => {
  ...
  }, [searchTerm, difficultyFilter, topicFilter, allProblems]);
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 flex flex-col">
              ...
              <div className="mb-4">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <option value="">Array, DP, String, ...</option>
                    {uniqueTopics.map((t) => (
          ...
          <div className="flex justify-end gap-3 mt-6">
            <button
              type="button"
              onClick={() => navigate("/admin/create-exam")}
              className="px-8 py-2.5 border border-gray-300 rounded-lg bg-white text-gray-700 text-sm font-semibold hover:bg-gray-50 transition"
            >
              Cancel
            </button>
            <button
              ...
              className="px-8 py-2.5 rounded-lg text-white text-sm font-semibold bg-gray-900 hover:bg-gray-800 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading
                ? isEditMode
                  ? "Updating..."
