...
//         {/* Input/Output Section - ONLY for Run */}
//         {!isSubmission &&
//           !currentCase.apiRes?.stderr &&
//           !currentCase.apiRes?.compile_output && (
...
const TestCaseOutput: React.FC<TestCaseOutputProps> = ({
  ...
  const getStatusColor = (status: string): string => {
    switch (status) {
      ...
      case "In Queue": case "Processing": return "text-amber-500 animate-pulse";
  ...
  const getStatusBadgeClass = (status: string): string => {
    switch (status) {
      ...
      case "In Queue": case "Processing": return "bg-amber-100 text-amber-700";
  ...
  const getStatusIcon = (status: string): string => {
    switch (status) {
      ...
      case "In Queue": case "Processing": return "⋯";
      default: return "•";
    }
  };
